...
const PropertyDetails = () => {
  const { id } = useParams();
  console.log(id);
  // get the house data by id filter
    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white border-gray-300 rounded-lg px-6 py-8 w-full mb-8 border">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <div className="flex gap-x-2">
                ...
                <button className="border border-violet-700 text-violet-700 hover:border-violet-500 hover:text-violet-500 rounded p-4 w-full text-sm transition ">
                  Call
                </button>
              </div>
            </form>
